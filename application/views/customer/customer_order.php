						...
						<div class="col-sm-12">
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									...
									<li class="hidden-480">
										<a data-toggle="" href="#" onclick="OrderModal('<?php echo base_url();?>index.php/customer/customer_orders/add_item');">
									...
									<!-- NEW TABLE --> 
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div> 
										<form class="form-horizontal" id="order-form" method="post" action="<?php echo base_url();?>index.php/customer/customer_orders/insert_order_final" >
												...
												<tr>
													...
													<td class="center" >
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/customer/customer_orders/delete_item_order/<?php echo $ordertemprow->order_id; ?>');">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/customer/customer_orders/delete_item_order/<?php echo $ordertemprow->order_id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
										...
										<!-- <div class="form-group">
											...
											<label class="col-sm-2 control-label no-padding-right" for="discount">Discount(<input type="text" style="width:30px;text-align:center;border:none;" name="discount" id="discount"  value="0" OnChange="TotalPayAmount()"; >%) :  </label>

											<div class="col-sm-4">
												<div class="input-group">
													<input type="text" name="disamt" id="disamt" class="form-control" readonly />
												</div>
											</div>
											
											
											<label class="col-sm-2 control-label no-padding-right" for="servicetax"> Service Tax(<input type="text" style="width:30px;text-align:center;border:none;" name="servicetax" id="servicetax"  value="0" OnChange="TotalPayAmount()" >%) : </label>

											<div class="col-sm-4">
												<div class="input-group">
													<input type="text" name="servamt" id="servamt" class="form-control" readonly  />
												</div>
											</div>
										</div>
										-->
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<div class="input-group">
													<input type="text" name="granttotal" id="granttotal" class="form-control" value="<?php echo $TotalAmt; ?>.00" readonly />
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group">
												<input class="form-control date-picker" name="cheque_date" id="cheque_date" type="text" data-date-format="dd-mm-yyyy" />
														<span class="input-group-addon">
															<i class="fa fa-calendar bigger-110"></i>
														</span>
												</div>
										...
										<div class="form-group">
											...
											<label class="col-sm-2 control-label no-padding-right green" for="order_staus"><b> Order Status : </b></label>
