				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="page-header">
							<h1>
								<?php echo strtoupper($this->session->userdata('user_name')); ?> Profile
...
&nbsp;
											...
											<div class="profile-contact-info">
												<div class="profile-contact-links align-left">
													<a href="#" class="btn btn-link" onclick="Profile('<?php echo base_url();?>index.php/customer/edit_profile/<?php echo $this->session->userdata('user_id'); ?>');" >
											...
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="signup"> <?php echo $userrow->address1; ?>, <?php echo $userrow->address2; ?>  </span>
