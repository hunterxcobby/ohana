							...
							<div class="tabbable">
								...
								<div class="tab-content">
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr style='color:<?php echo $color; ?>'>
																...
																<td>
																	<?php	
																		$filenameo="assets/stock/ser_".$row->id.".png";
																		if (!file_exists($filenameo)) {   
																			$filefoundo = 0;                         
																		} else 
																		{   $filefoundo=$row->id; } 
																	?>
																	<img src="<?php echo base_url();?>assets/stock/ser_<?php echo $filefoundo;?>.png" style="height:35px; width:35px;">										
																</td>
																<td><?php echo $row->service_name; ?> </td>
															<!--	<td><?php echo $row->service_name_lang; ?> </td> -->
																<!-- <td>
																	<?php 
									...
									<div class="">
										...
										<!--
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="service_name"> <?php echo lang('Service Name'); ?>  (<?php echo ucwords($this->db->get_where('settings' , array('id' =>'1'))->row()->sys_lang); ?>) : </label>
