			...
			<div class="page-header ">
				<h1 class="hidden-480" >
					...
					<small>
						...
						<?php echo lang('Service Management'); ?> 
					</small>
				</h1>
			</div><!-- /.page-header -->
							...
							<div class="tabbable">
								...
								<div class="tab-content">
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div class="table-header" style="background:#A069C3!important;">
													<?php echo lang('Service List'); ?> Service List 
												</div>
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																...
																<th>Template ID# </th>
																<th class="hidden-480"> Template Name  </th> 
														...
														<tbody>
															<?php $sr=1; 
															foreach ($message_template->result() as $msgrow): 
															// $color=''; if($msgrow->show_hide=="hide") $color='red';
															...
															<tr style='color:<?php echo $color; ?>'>
																...
																<td> <?php echo $msgrow->msg_id; ?> </td>
																
																<td><?php echo $msgrow->msg_title; ?> </td>
																<td style='width:400px;text-align:justify;'><?php echo $msgrow->msg_body; ?> </td>
																<td class=""><?php echo $msgrow->message_for; ?> </td>
																<td class=""> <?php echo strtoupper($msgrow->active); ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/message_crud/do_update/<?php echo $msgrow->msg_id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/message_crud/delete/<?php echo $msgrow->msg_id;?>');">
									...
									<div class="">
										...
										echo form_open('admin/message_crud/create',$attributes); ?>
										...
										<div class="form-group ">
											...
											<div class="col-sm-9">
												<input type="text" name="msg_id" id="msg_id" class="form-control" required readonly value="<?php echo $last_id+1; ?>" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<select name="message_for" id="message_for" class="form-control"  required />
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="msg_title"> Message Title / Subject : </label>

											<div class="col-sm-9">
												<input type="text" name="msg_title" class="form-control" placeholder="pickup, newcustomer,delivery etc" required  autofocus/>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<textarea id="msg_body" name="msg_body" class="form-control" rows="6" ></textarea>
											</div>
										</div>
