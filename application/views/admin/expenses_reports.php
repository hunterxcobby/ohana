	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo lang('Expenses Reports'); ?>  </li>
			</ul><!-- /.breadcrumb -->
									...
									<!-- NEW TABLE --> 
										...
										<div class="row">
											<div class="">
												...
												echo form_open('admin/expenses_report/visible',$attributes); ?>
											...
											<div class="col-xs-12">
												...
												<div class="table-header" style="background:#87B87F!important">
													<?php echo lang('Expenses Reports'); ?>  
												</div>
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																...
																<th class="hidden-480"> Bill No# </th>
														...
														{
														echo '<tr><td></td><td colspan="3"> Not found any records...</td><td style="display: none;"></td><td ></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>';	
														}
														else
														{ 
															$NetAmt=0;
															...
															<tr>
																...
																<!-- <td>
																	<?php echo date('F',strtotime($row->exps_date)); ?>
																</td> -->
																	
																<td class=""><?php echo $row->exp_payee_name; ?> </td>
																<td class="hidden-480"><?php echo $row->exp_type; ?><br/> <?php if($row->exp_remarks!='') { echo '<small>['.$row->exp_remarks.']</small>'; } ?> </td>
																
																
																<td class="hidden-480"><?php echo $row->exp_paidby; ?> </td>
																<!-- <td class="hidden-480"><?php echo $row->exp_remarks; ?> </td>															 -->
																<td style="text-align:right;"> <?=sprintf('%0.3f',$TotalAmt=$row->exp_amt); ?> </td>

																<!-- <td style="text-align:right;"> 0.000 </td> -->

															<?php
															if($row->exp_taxable=='yes')
															{
																$Tax=($row->exp_taxable=='yes')? $TotalAmt/11 : 0;
															...
															?>	
																...
																<td style="text-align:right;"> <?=sprintf('%0.3f',$Taxable); ?> </td>

																<td style="text-align:right;"> <?=sprintf('%0.3f',$Tax); ?> </td>


																<td style="text-align:right;"> <?=sprintf('%0.3f',$NetAmt=$Taxable+$Tax); ?> </td>
																
																
															<?php
															$FinalTotal=$FinalTotal+$TotalAmt;
															$FinalTaxable=$FinalTaxable+$Taxable;
															...
															<?php $sr++; endforeach; ?>
															<tr>
															<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td> Total : </td> <td style="text-align:right;font-weight:bold;"> <?=sprintf('%0.3f',$FinalTotal)?> </td>
															</tr>
															<tr>
															<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td> Taxable : </td> <td style="text-align:right;font-weight:bold;"> <?=sprintf('%0.3f',$FinalTaxable)?> </td>
															</tr>
															<tr>
															<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td> Tax : </td> <td style="text-align:right;font-weight:bold;"> <?=sprintf('%0.3f',$FinalTax);?> </td>
															</tr>
															<tr>
															<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><td> Net Total : </td> <td style="text-align:right;font-weight:bold;"> <?=sprintf('%0.3f',$FinalNetAmt)?> </td>
															</tr>
														<?php 
														}
														?>	
