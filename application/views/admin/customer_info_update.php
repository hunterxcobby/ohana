								...
								<div class="tab-content">
									...
									<div class="">
										...
										<div class="form-group ">
											<label class="col-sm-2 control-label no-padding-right" for="user_id"> Customer ID : </label>

											<div class="col-sm-4">
												<input type="text" id="user_id" class="form-control" readonly value="<?php echo $last_id+1; ?>" />
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="join_date"> Join Date : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="first_name"> First Name : </label>

											<div class="col-sm-4">
												<input type="text" name="first_name" id="first_name" class="form-control"  autofocus/>
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="last_name"> Last Name : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="email"> Email ID : </label>

											<div class="col-sm-4">
												<input type="email" name="email" id="email" class="form-control"  />
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="phone"> Mobile : </label>
										...
										<div class="form-group">
											...
											<label class="col-sm-2 control-label no-padding-right" for="status"> <span style="color:#5cb85c!important;"> Login Status : </span>  </label>
