...
<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						...
						<span style="color:blue; font-size:11px;"> Note: Click on </span> <i class="ace-icon fa fa-download"></i> <span style="color:blue; font-size:11px;"> Download Invoice </span>
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-large">
												...
												<div class="widget-toolbar">
													<a href="<?php echo base_url(); ?>index.php/admin/invoicepdf/<?php echo $invoicerow->auto_id; ?>" title="Download Invoice" target="_blank">
												...
												<div class="widget-main padding-24">
													<div class="row">
														<div class="col-sm-6">
															...
															<div>
																<?php 
																$setting_sys = $this->db->get('settings');
																
																foreach($setting_sys->result() as $syst) : ?>
																
																<ul class="list-unstyled spaced">
																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i><?php echo $syst->shop_name; ?>
																	</li>

																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i><?php echo $syst->shop_mobile; ?>
																	</li>

																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i><?php echo $syst->shop_add; ?>
																	</li>

																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i>
Phone:
																		<b class="red"><?php echo $syst->shop_phone; ?></b>
																	</li>
										...
										<table id="price-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td> 
														...
														if($Short_Code==$pricerow->id)
														{
															...
															echo $sys_curr." ".sprintf('%0.2f',$DispPrice=($Price*$Qty));
												...
												<tr >																
													<td colspan='5'> </td>
													<td> Total : </td> <td> <?php echo $sys_curr." ".sprintf('%0.2f', $TotalAmt); ?> </td>
												</tr>
												
												<tr >																
													<td colspan='5'> </td>
													<td>  Discount (<?php echo $Discount=$invoicerow->discount; ?>%) : </td> <td> <?php echo $sys_curr." ".sprintf('%0.2f', $DisAmt=$TotalAmt*$Discount/100); ?> </td>
												</tr>
												
												<tr >																
													<td colspan='5'> </td>
													<td> Ser Tax (<?php echo $ServiceTax=$invoicerow->service_tax; ?> %): </td> <td> <?php echo $sys_curr." ".sprintf('%0.2f', $SerAmt=($TotalAmt-$Discount)*$ServiceTax/100); ?> </td>
												</tr>
													...
													<div class="row">
														<div class="col-sm-5 pull-right">
															<h4 class="pull-right">
																Grand Amount :
																<span class="red"><?php echo $sys_curr." ".sprintf('%0.2f', $invoicerow->total_paid); ?> </span>
															</h4>
														</div>
