						...
						<div class="col-sm-12">
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									...
									<li class="hidden-480">
										<a data-toggle="" href="#" onclick="OrderModal('<?php echo base_url();?>index.php/admin/customer_orders/add_item');">
								...
								<div class="tab-content">
									...
									<!-- NEW TABLE --> 
										...
										<div class="row">
											<div class="col-xs-12">
												...
												<div> 
										<form class="form-horizontal" id="order-form" method="post" action="<?php echo base_url();?>index.php/admin/customer_orders/insert_order_final" >
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" name="invoice_no"  id="invoice_no" class="form-control" readonly value="<?php echo "DRL" . ($last_id+1); ?>" />
											</div>
											...
											<div class="col-sm-4">
												<div class="input-group">
													<input class="form-control " name="order_date" id="order_date" type="text" data-date-format="dd-mm-yyyy" value="<?php echo date('d-m-Y',strtotime($Order_Date)); ?>" readonly />
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												 <input type="text" id="cust_name" class="form-control" readonly value="<?php echo $Disp_Party_Name; ?>" /> 
											</div>
										...
										<table id="price-table" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<td class="center" >
														<div class="hidden-sm hidden-xs action-buttons">
															...
															<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/customer_orders/delete_item_order/<?php echo $ordertemprow->order_id; ?>');">
														...
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	...
																	<li>
																		<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/customer_orders/delete_item_order/<?php echo $ordertemprow->order_id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																			<span class="red">
												...
												<td> <b> Sub 	Total </b> </td> <td class="center"> <b> <?php echo $TotalQty; ?> </b> </td> <td > -  </td> <td> <b> <?php echo $sys_curr ." ".sprintf('%0.2f',$SubTotalAmt); ?> </b> </td> <td>  </td>
										...
										<div> <hr style='color: 1px solid blue;'> </div>										
											<div>	<!--
													...
													<input type="text" name="dis_amt" id="dis_amt" class="form-control" value="0.00" OnChange="TotalPayAmount();" />
									...
									<div class="form-group">
											...
											<div class="col-sm-4">
													...
													<input type="text" name="granttotal" id="granttotal" class="form-control" value="<?php echo sprintf('%0.2f',($grandtotal=$SubTotalAmt+$Minuscharges+$Pluscharges)); ?>" readonly />
									...
									<div> <hr style='color: 1px solid blue;'> </div>										
										...
										<div  class="form-group"  >
											...
											<div class="col-sm-4">
												...
												<select class="form-control" name="paidby" id="paidby" disabled >
													...
													<option value="notpaid" selected>Pending Paid</option>
													<option value="paid" >Collected</option>
													
												</select>
												<input type="hidden" name="paidby" id="paidby" value="notpaid">
											</div>
											...
											<div class="col-sm-4">
												...
												<input class="form-control date-picker" name="cheque_date" id="cheque_date" type="text" data-date-format="dd-mm-yyyy" value=""  disabled />
														<span class="input-group-addon">
															<i class="fa fa-calendar bigger-110"></i>
														</span>
												</div>
										...
										<div  class="form-group"  >
											...
											<label class="col-sm-2 control-label no-padding-right" for="paidby"> Order Status : </label>
											...
											<div class="col-sm-4">
													...
													<input type="text" name="remarks" id="remarks" class="form-control"   value="" required />
