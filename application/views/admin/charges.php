	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo lang('Charges List'); ?>  </li>
			</ul><!-- /.breadcrumb -->
							...
							<div class="tabbable">
								...
								<div class="tab-content">
											...
											<div class="col-xs-12">
												...
												<div>
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															<?php foreach ($tax_charges->result() as $row): ?>
															<tr>
																<td class="center">
																	<label class="pos-rel">
																		<input type="checkbox" class="ace" />
																...
																<td>
																<?php 
																if($row->transaction==0) { echo " ( - ) "; } 
																if($row->transaction==1) { echo " ( + ) "; } 
																...
																<td> <?php echo strtoupper($row->defaults); ?> </td>
																<!-- <td> <?php echo strtoupper($row->coupon); ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/charge_crud/do_update/<?php echo $row->charge_id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/charge_crud/delete/<?php echo $row->charge_id;?>');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/charge_crud/do_update/<?php echo $row->charge_id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/charge_crud/delete/<?php echo $row->charge_id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
									...
									<div class="">
										...
										echo form_open('admin/charge_crud/create',$attributes); ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="charge_name" class="form-control" placeholder="Govt Tax, Vat, Home Delivery, Permenent Discount etc" required  autofocus/>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="charge_type"> <?php echo lang('In Transaction'); ?>  : </label>

											<div class="col-sm-9">
												<select class="form-control" name="transaction" id="transaction">
													<option value="1" selected> <?php echo lang('Add Amount'); ?>  </option>
													<option value="0"> <?php echo lang('Minus Amount'); ?>  </option>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="charge_value"> <?php echo lang('Default (Y/N)'); ?>  : </label>

												<div class="col-sm-9">
												<select class="form-control" name="defaults" id="defaults" >
													<option value="" selected><?php echo lang('No'); ?></option>
										...
										<!--
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="charge_value"> Coupon(Y/N) : </label>

												<div class="col-sm-9">
												<select class="form-control" name="coupon" id="coupon" required>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="charge_remarks" class="form-control" />
											</div>
										</div>
