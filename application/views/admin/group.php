						...
						<div class="col-sm-12">
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									...
									<li>
										<a href="<?php base_url();?>group_permission">
			...
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th class="center"><?php echo lang('Sr.No.'); ?></th>
				...
				<tbody>
					<?php $sr=0; foreach ($groups->result() as $row): $sr++; ?>
					<tr>
						...
						echo "<span style='font-size:11px;color:#5cb85c'> Permission (";
						$grpperm=unserialize($row->group_permission);
						
						foreach($grpperm as $grp )
						{
							echo $p=ucwords($grp).", ";
						}
						echo ") </span>";
						...
						<td class="">
							<?php 
							if($row->group_status=="enable")
							{
							?>	
								<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/group_crud/do_update/<?php echo $row->id;?>');">
									<span style='color:green;'> <?php echo lang('Enable'); ?>  </span>
								</a>
							<?php	
							}
							...
							?>
								<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/group_crud/do_update/<?php echo $row->id;?>');">
									<span style='color:red;'> <?php echo lang('Disable'); ?>  </span>
								</a>
							<?php	
							}
						...
						<td>
							<div class="hidden-sm hidden-xs action-buttons">
								...
								<a class="green" href="<?php echo base_url();?>index.php/admin/group_permission/<?php echo $row->id;?>" >
									<i class="ace-icon fa fa-pencil bigger-130"></i>
								</a>

								<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/group_crud/delete/<?php echo $row->id;?>');">
							...
							<div class="hidden-md hidden-lg">
								<div class="inline pos-rel">
									...
									<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
										...
										<li>
											<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/group_crud/do_update/<?php echo $row->id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
												<span class="green">
										...
										<li>
											<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/group_crud/delete/<?php echo $row->id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
												<span class="red">
