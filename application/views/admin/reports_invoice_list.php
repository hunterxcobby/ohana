									...
									<!-- NEW TABLE --> 
										...
										<div class="row">
											<div class="">
												...
												echo form_open('admin/orderreport/date_view/visible',$attributes); ?>
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																...
																<th style="width:100px;">Received Amt  </th>
                ...
                <th style="text-align:right;"></th> 
														...
														<tbody>
															...
															<tr>
																...
																?>
																<td style='color:<?php echo $colr; ?>;width:200px;'>
																<?php 
																...
																<td style="text-align:right;"><?php echo sprintf('%0.3f',$invoicerow->amt_paid); ?> </td>
...
<script src="<?php echo base_url();?>assets/js/jquery-2.1.4.min.js"></script>
	...
	<script type="text/javascript">
		...
		<script type="text/javascript">
            ...
            $( api.column(9).footer() ).html( parseFloat(received_total).toFixed(3) );
