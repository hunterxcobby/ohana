				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#"><?php echo lang('System'); ?> </a> <?php echo "( " . date('j-M-Y h:i A') ." )"; ?>
							</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="term_condition"> Terms and Conditions : </label>

											<div class="col-sm-9">
												<textarea id="term_condition" name="term_condition" class="form-control" rows="6" ><?=$sysrow->terms?></textarea>
											</div>
										</div>
