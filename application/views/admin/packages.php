	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Laundry Package </li>
			</ul><!-- /.breadcrumb -->
							...
							<div class="tabbable">
								...
								<div class="tab-content">
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																...
																<td><?php echo $row->usage_limit; ?> <?php echo $row->pkg_unit; ?> </td>
																<td><?php echo $row->pickup; ?> </td>
																<td><?php echo $row->duration; ?> Month(s) </td>
																<td><?php echo $row->amount; ?> </td>
																<td class="hidden-480"><?php echo $row->description; ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/pkg_crud/do_update/<?php echo $row->pkg_id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/pkg_crud/delete/<?php echo $row->pkg_id;?>');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/pkg_crud/do_update/<?php echo $row->pkg_id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/pkg_crud/delete/<?php echo $row->pkg_id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
									...
									<div class="">
										...
										echo form_open('admin/pkg_crud/create',$attributes); ?>
