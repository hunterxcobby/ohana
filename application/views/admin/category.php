								...
								<div class="tab-content">
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr style='color:<?php echo $color; ?>'>
																...
																<td><?php echo $row->category_descr; ?> </td>
																															
																<td class=""> <?php echo $row->show_hide; ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/category_crud/do_update/<?php echo $row->cat_id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/category_crud/delete/<?php echo $row->cat_id;?>');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/admin/category_crud/do_update/<?php echo $row->cat_id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/admin/category_crud/delete/<?php echo $row->cat_id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
									...
									<div class="">
										...
										<div class="form-group ">
											...
											<div class="col-sm-9">
												<input type="text" name="category_id" id="category_id" class="form-control" required readonly value="<?php echo $last_id+1; ?>" />
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label no-padding-right" for="active">  Status : </label>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="category_descr" class="form-control" />
											</div>
										</div>
