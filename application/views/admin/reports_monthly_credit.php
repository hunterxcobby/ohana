	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Datewise Credit Reports </li>
			</ul><!-- /.breadcrumb -->
									...
									<!-- NEW TABLE --> 
										...
										<div class="row">
											<div class="">
												...
												echo form_open('admin/monthly_credit_report/visible',$attributes); ?>
													
												<div class="form-group">
														<label class="col-sm-1 control-label no-padding-right" for="year"> Year : </label>
														<div class="col-sm-2">
														<select class="chosen-select form-control" name="year" id="year" data-placeholder="Choose a Year..." required>
											...
											<div class="col-xs-12">
												...
												<div class="table-header" style="background:#A069C3!important;">
													<?php echo lang('Monthwise Report List'); ?> 
												</div>
												...
												<!-- div.dataTables_borderWrap -->
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															$orderDate=date('m',strtotime($invoicerow->order_date)); 
															$this->db->select();
															$this->db->select_sum('amt_paid');
															$this->db->where('amt_paidby!=','notpaid');
															$paidAmt=$this->db->get_where('customer_order',array('MONTH(order_date)' => $orderDate))->row()->amt_paid;
															...
															<tr>
																...
																<td>
																	<?php echo date('F',strtotime($invoicerow->order_date)); ?>
																</td>
