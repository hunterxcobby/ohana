<?php foreach ($cloths_edit as $row): ?>
		...
		<div class="">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="cloth_name"> <span style="font-size:12px;"> <?php echo lang('Food Name'); ?> (English) : </span> </label>
			...
			<!--
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="cloth_name"> <span style="font-size:12px;"> <?php echo lang('Food Name'); ?> (<?php echo ucwords($this->db->get_where('settings' , array('id' =>'1'))->row()->sys_lang); ?>) : </span> </label>
