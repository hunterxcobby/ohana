		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts" style='margin-top:10px;'>
					...
					<strong class="red"> Welcome, <?php echo strtoupper($this->session->userdata('emp_name')); ?> </strong>
					<!-- 
				...
				<ul class="nav nav-list">
					...
					<li class="<?php if($active_menu=='orders') echo "active open"; ?>"">
						...
						<ul class="submenu">
							<li class="<?php if($active_submenu=='pickorders') echo "active"; ?>">
								<a href="<?php echo base_url();?>index.php/employee/pickupdelivery">
						...
						<ul class="submenu">
							<li class="<?php if($active_submenu=='delivorders') echo "active"; ?>">
								<a href="<?php echo base_url();?>index.php/employee/pickupdelivery">
									<i class="menu-icon fa fa-caret-right"></i>
									Delivery Orders
								</a>
					...
					<li class="">
						<a href="<?php echo base_url();?>index.php/employee/logout">
