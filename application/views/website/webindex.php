...
<!-- slider revolution -->
				...
				<ul>
					...
					<li data-transition='fade' data-rotate='0' data-saveperformance='off'>
						...
						<div class="tp-caption tp-hovertext" id="tp-hovertext-2" data-width="['960','600','496','384']" data-x="['right','right','right','right']" data-hoffset="['0']" data-y="['center','center','center','center']" data-voffset="['-35','-25','-18','-15']" data-textAlign="['center','center','center','center']" data-paddingright="[265,180,150,0]" data-frames='[{"from":"y:[300%];opacity:0;","speed":3000,"to":"o:1;","delay":1000,"ease":"Power3.easeOut"},{"delay":"wait","speed":1000,"to":"y:[200%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]' style="z-index: 6;">
							<div class="rs-text-1">Dry Cleaning Service</div>
							<div class="rs-text-2">We clean everything</div>
						</div>
						<!-- 1-2-button -->
						...
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":0,"speed":7000,"frame":"0","from":"y:bottom;","to":"y:top","ease":"Power3.easeInOut"}]' style="z-index: 9;">
							<img src="<?php echo base_url();?>web/images/slider/bubble-1-02.png" alt="" data-hh="['778','486','402','311']">
						</div>
						<!-- bubble-1-2 move out -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":1000,"speed":7000,"frame":"0","from":"y:bottom;","to":"y:top","ease":"Power3.easeInOut"}]' style="z-index: 9;">
							<img src="<?php echo base_url();?>web/images/slider/bubble-1-04.png" alt="" data-hh="['778','486','402','311']">
						</div>
						<!-- bubble-1-3 move out -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":500,"speed":7000,"frame":"0","from":"y:bottom;","to":"y:top","ease":"Power3.easeInOut"}]' style="z-index: 9;">
							<img src="<?php echo base_url();?>web/images/slider/bubble-1-01.png" alt="" data-hh="['778','486','402','311']">
						</div>
						<!-- bubble-1-4 move out -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":3000,"speed":7000,"frame":"0","from":"y:bottom;","to":"y:top","ease":"Power3.easeInOut"}]' style="z-index: 9;">
							<img src="<?php echo base_url();?>web/images/slider/bubble-1-03.png" alt="" data-hh="['778','486','402','311']">
						</div>
						<!-- bubble-1-1 -->
						...
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-1">
								<img src="<?php echo base_url();?>web/images/slider/glow-1-01.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- glow-1-2 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-2">
								<img src="<?php echo base_url();?>web/images/slider/glow-1-02.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- glow-1-3 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-3">
								<img src="<?php echo base_url();?>web/images/slider/glow-1-03.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
					</li>
					<!-- Slide 2 -->
					<li data-transition='fade' data-rotate='0' data-saveperformance='off'>
						<img src="<?php echo base_url();?>web/images/slider/slide2.jpg" alt="slide1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
						<!-- 2-1-text -->
						<div class="tp-caption" data-width="['735','500','400','450']" data-x="['center','center','center','center']" data-hoffset="['300', '200','150','80']" data-y="['center','center','center','center']" data-voffset="['-55','-25','-20','-34']" data-textAlign="['center','center','center','center']" data-frames='[{"from":"y:[300%];opacity:0;","speed":1500,"to":"o:1;","delay":2500,"ease":"Power3.easeOut"},{"delay":"wait","speed":1000,"to":"y:[200%];","ease":"Power2.easeInOut"}]' style="z-index: 6;">
							<div class="rs-text-block-center">
								<div class="rs-text-1 color-grey text-center">The most convenient
									<br>way to do laundry and
									<br>dry cleaning</div>
								<div class="rs-text-2 color-grey">We provide on-demand pick-up and delivery
									<br> service in as little as 20 minutes</div>
							</div>
						</div>
						<!-- 2-1-button -->
						<a href="#mobile" class="tp-caption rs-btn btn-green popup-link" data-x="['center','center','center','center']" data-hoffset="['300','200','150','80']" data-y="['center','center','center','center']" data-voffset="['150','100','75','85']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-responsive="off" data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","speed":1500,"to":"o:1;","delay":3000,"ease":"Power3.easeInOut"}, {"delay":"wait","speed":1000,"to":"auto:auto;","ease":"Power2.easeInOut"}]' style="z-index: 23;">Mobile App
	  					</a>
						<!-- 2-1-image -->
						<div class="tp-caption tp-full-image" data-x="['center','center','center','center']" data-y="['bottom','bottom','bottom','bottom']" data-width="['1920', '1200', '992', '768']" data-hoffset="['0','0','0','-70']" data-height="['778','486','402','311']" data-type="image" data-responsive_offset="off" data-responsive="on" data-frames='[{"from":"x:-100px;opacity:0;","speed":1000,"to":"o:1;","delay":1000,"ease":"Power3.easeOut"},{"delay":"wait","speed":3000,"to":"opacity:0;","ease":"Power4.easeIn"}]' style="z-index: 15;"><img src="<?php echo base_url();?>web/images/slider/slide2-1.png" alt=""> </div>
						<!-- 2-2-image -->
						<div class="tp-caption tp-full-image" data-x="['center','center','center','center']" data-y="['bottom','bottom','bottom','bottom']" data-width="['1920', '1200', '992', '768']" data-hoffset="['0','0','0','-70']" data-height="['778','486','402','311']" data-type="image" data-responsive_offset="off" data-responsive="on" data-frames='[{"from":"o:0;","speed":1500,"to":"o:1;","delay":2000,"ease":"Power3.easeOut"},{"delay":"wait","speed":3000,"to":"opacity:0;","ease":"Power4.easeIn"}]' style="z-index: 15;"><img src="<?php echo base_url();?>web/images/slider/slide2-2.png" alt=""> </div>
						<!-- bubble-1-1 move out -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":0,"speed":7000,"frame":"0","from":"y:bottom;","to":"y:top","ease":"Power3.easeInOut"}]' style="z-index: 9;">
							<img src="<?php echo base_url();?>web/images/slider/bubble-1-02.png" alt="" data-hh="['778','486','402','311']">
						</div>
						...
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":1000,"speed":5000,"frame":"0","from":"y:bottom;","to":"y:0","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"y:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-looped rs-pulse" data-easing="Power3.easeInOut" data-speed="3" data-zoomstart="1" data-zoomend="0.9">
								<img src="<?php echo base_url();?>web/images/slider/bubble-2-01.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- bubble-2-2 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":2000,"speed":5000,"frame":"0","from":"y:bottom;","to":"y:0","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"y:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-looped rs-pulse" data-easing="Power3.easeInOut" data-speed="6" data-zoomstart="1" data-zoomend="0.9">
								<img src="<?php echo base_url();?>web/images/slider/bubble-2-02.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- bubble-2-3 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":3000,"speed":5000,"frame":"0","from":"y:bottom;","to":"y:0","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"y:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-looped rs-pulse" data-easing="Power3.easeInOut" data-speed="4" data-zoomstart="1" data-zoomend="0.9">
								<img src="<?php echo base_url();?>web/images/slider/bubble-2-03.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- bubble-2-4 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"y:bottom;","to":"y:0","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"y:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-looped rs-pulse" data-easing="Power3.easeInOut" data-speed="5" data-zoomstart="1" data-zoomend="0.9">
								<img src="<?php echo base_url();?>web/images/slider/bubble-2-04.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- bubble-2-5 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":2000,"speed":5000,"frame":"0","from":"y:bottom;","to":"y:0","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"y:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-looped rs-pulse" data-easing="Power3.easeInOut" data-speed="5" data-zoomstart="1" data-zoomend="0.9">
								<img src="<?php echo base_url();?>web/images/slider/bubble-2-05.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- glow-2-1 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-1">
								<img src="<?php echo base_url();?>web/images/slider/glow-2-01.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- glow-2-2 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-2">
								<img src="<?php echo base_url();?>web/images/slider/glow-2-02.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
						<!-- glow-2-3 -->
						<div class="tp-caption tp-resizeme tp-full-height" data-x="center" data-y="top" data-height="full" data-type="image" data-responsive="on" data-frames='[{"delay":4000,"speed":5000,"frame":"0","from":"o:0;","to":"o:1","ease":"Power3.easeInOut"},{"delay":"wait","speed":5000,"frame":"999","to":"o:0;","ease":"Power3.easeInOut"}]' style="z-index: 10;">
							<div class="rs-glow-3">
								<img src="<?php echo base_url();?>web/images/slider/glow-2-03.png" alt="" data-hh="['778','486','402','311']">
							</div>
						</div>
					</li>
					<!-- Slide 3 -->
					<li data-transition='fade' data-rotate='0' data-saveperformance='off'>
						<img src="<?php echo base_url();?>web/images/slider/slide1.jpg" alt="slide1" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
						<!-- 3-1-image -->
						<div class="tp-caption tp-scale" id="slide-3-1" data-x="['center','center','center','center']" data-hoffset="['-480','-300','-248','-192']" data-y="['top','top','top','top']" data-voffset="['0','0','0','0']" data-width="['961','601','497','385']" data-height="['778','486','402','311']" data-whitespace="nowrap" data-type="image" data-basealign="slide" data-responsive_offset="on" data-frames='[{"from":"o:0;","speed":1000,"to":"o:1","delay":0,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1500,"to":"x:left;","ease":"Power2.easeInOut"}]' style="z-index: 1;"><img src="<?php echo base_url();?>web/images/slider/slide3-1.jpg" alt="">
						</div>
						<!-- 3-2-image -->
						<div class="tp-caption tp-scale" id="slide-3-2" data-x="['center','center','center','center']" data-hoffset="['480','300','248','192']" data-y="['top','top','top','top']" data-voffset="['0','0','0','0']" data-width="['961','601','497','385']" data-height="['778','486','402','311']" data-whitespace="nowrap" data-type="image" data-basealign="slide" data-responsive_offset="on" data-frames='[{"from":"o:0;","speed":1000,"to":"o:1","delay":0,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1500,"to":"x:right;","ease":"Power2.easeInOut"}]' style="z-index: 1;"><img src="<?php echo base_url();?>web/images/slider/slide3-2.jpg" alt="">
						</div>
						<!-- 3-1-blank -->
	...
	<div class="page-content">
		<div class="container offset-top-35">
			<div class="row services-box-mobile arrow-on-white">
				<div class="col-md-4">
					<!-- services-box -->
					<a href="#" class="services-box fill-bg-1 animation" data-animation="fadeInUp" data-animation-delay="0.5s">
						<div class="icon-box">
				...
				<a href="#" class="col-md-4">
					<!-- services-box -->
					<div class="services-box  fill-bg-2 animation" data-animation="fadeInUp" data-animation-delay="0s">
						<div class="icon-box">
						...
						<h5 class="title">Dry Cleaning Services</h5>
						<p>
				...
				<a href="#" class="col-md-4">
					<!-- services-box -->
					<div class="services-box fill-bg-3 animation" data-animation="fadeInUp" data-animation-delay="0.5s">
						<div class="icon-box">
						...
						<h5 class="title">Shoes Cleaning</h5>
						<p>
							To keep shoes at peak performance, we recommend professional deep cleaning your shoes every 3 to 6 months.
						</p>
					</div>
					<!-- /services-box -->
				</a>
			...
			<div class="container offset-top0">
				<div class="row">
					<div class="box-step animation" data-animation="fadeIn" data-animation-delay="0s">
						...
						<a href="#" class="item">
							<div class="icon">
								<img src="<?php echo base_url();?>web/images/img_icon_01.png" class="img-responsive1" alt="">
							</div>
						...
						<a href="#" class="item animation" data-animation="fadeIn" data-animation-delay="0.25s">
							<div class="icon">
								<img src="<?php echo base_url();?>web/images/img_icon_02.png" class="img-responsive1" alt="">
							</div>
							<h6 class="description">Step 2</h6>
							<h4 class="title">We <span>pick up</span> your
								<br> clothes</h4>
						</a>
						<a href="#" class="item animation" data-animation="fadeIn" data-animation-delay="0.5s">
							<div class="icon">
								<img src="<?php echo base_url();?>web/images/img_icon_03.png" class="img-responsive1" alt="">
							</div>
							<h6 class="description">Step 3</h6>
							<h4 class="title">We <span>clean</span> your
								<br> clothes</h4>
						</a>
						<a href="#" class="item animation" data-animation="fadeIn" data-animation-delay="0.75s">
							<div class="icon">
								<img src="<?php echo base_url();?>web/images/img_icon_04.png" class="img-responsive1" alt="">
							</div>
		...
		<div class="container offset-top90">
			<div class="row">
				<div class="col-md-5">
					<h2 class="title-underline">Our Approach</h2>
					<p class="text-center">
				...
				<div class="col-md-7">
					<div class="video-indent">
						<video width="500" height="400" controls>
                          <source src="<?php echo base_url();?>assets/video/ahl_video.mp4" type="video/mp4">
		...
		<div class="container">
			...
			<div class="row product-box-mobile arrow-on-white">
				<div class="col-md-4">
					...
					<a href="#" class="product-box animation" data-animation="fadeInUp" data-animation-delay="0s">
						...
						<h3 class="title">
							From <span class="base-color"><?php echo $sys_curr; ?> 2 </span> per cloths
						</h3>
			...
			<div class="text-center offset-top35"><a href="<?php echo base_url();?>index.php/website/pricelist" class="btn btn-default btn-green">See all prices here</a></div>
		</div>
		<div class="fill-bg-2 offset-top60 clearfix" id="mobile">
			<div class="apps-bnr">
				<div class="apps-bnr-inside">
					<img src="<?php echo base_url();?>web/images/banner-apps.jpg" class="img-responsive" alt="">
					<div class="apps-bnr-caption">
						<div class="apps-bnr-text1">Tap. Clean. Deliver.</div>
						<div class="apps-bnr-text2">Order even faster</div>
						<div class="apps-bnr-btns">
							<a href="https://play.google.com/store/apps/details?id=com.redplanetcomputers.al_hayat_customer"><img src="<?php echo base_url();?>web/images/btn-google-play.png" alt=""></a>
							<a href="https://play.google.com/store/apps/details?id=com.redplanetcomputers.al_hayat_customer"><img src="<?php echo base_url();?>web/images/btn-app-store.png" alt=""></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<h2 class="title-underline">Why Choose Us</h2>
		...
		<div class="content carusel--parallax" data-image="<?php echo base_url();?>web/images/parallax-img-01.jpg">
					...
					<div class="container">
						<div class="row">
							<div class="carousel-blog-box">
								...
								<div class="col-xs-9">
									<div class="center-y">
										<h4 class="title"><a href="#">Charles N. Rock</a></h4>
										<div class="description">
	...
	<!--	<div class="content content--parallax offset-top0" data-image="<?php echo base_url();?>web/images/parallax-img-03.jpg">
			<div class="container">
				<h2 class="title-underline">PACKAGES</h2>
				<div class="row">
					<div class="col-md-4 animation" data-animation="fadeInUp" data-animation-delay="0.5s">
						<div class="price-block">
							<div class="price-block-title">Standart</div>
							<div class="price-block-price"><?php echo $sys_curr; ?>349</div>
							<div class="price-block-details"><span>50</span> Clothes Per Month:</div>
							<ul>
								<li>4 t-shirts</li>
							...
							<a href="<?php echo base_url();?>index.php/website/pricelist" class="btn btn-default btn-grey">CHOOSE PLAN</a>
						</div>
					</div>
					<div class="col-md-4 animation" data-animation="fadeInUp" data-animation-delay="0s">
						<div class="price-block price-block--blue">
							<div class="price-block-title">Еnterprise</div>
							<div class="price-block-price"><?php echo $sys_curr; ?>399</div>
							<div class="price-block-details"><span>60</span> Clothes Per Month:</div>
							<ul>
								<li>4 t-shirts</li>
								<li>1 pairs of jeans</li>
								<li>3 button-down shirts</li>
							...
							<a href="<?php echo base_url();?>index.php/website/pricelist" class="btn btn-default btn-blue">CHOOSE PLAN</a>
						</div>
					</div>
					<div class="col-md-4 animation" data-animation="fadeInUp" data-animation-delay="0.5s">
						<div class="price-block price-block--green last">
							<div class="price-block-title">PREMIUM
								<span class="sale-label">-10%</span>
							</div>
							<div class="price-block-price"><span class="price-old"><?php echo $sys_curr; ?>499</span><?php echo $sys_curr; ?>449</div>
							<div class="price-block-details"><span>80</span> Clothes Per Month:</div>
							<ul>
								<li>6 t-shirts</li>
							...
							<a href="<?php echo base_url();?>index.php/website/pricelist" class="btn btn-default btn-green">CHOOSE PLAN</a>
						</div>
					</div>
				</div>
				<div class="text-center offset-top50"><a href="<?php echo base_url();?>index.php/website/pricelist" class="read-more">View  Package  Details</a></div>
			</div>
		</div> -->
		<div class="container-fluid content offset-top0">
			<div id="map"></div>
		</div>
	</div>
...
<?php include('footer.php'); ?>
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkYWtyawIWihA2jJAOAGlJq6mHeG3C6Ro"></script>

	<!-- REVOLUTION JS FILES -->
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/jquery.themepunch.tools.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/jquery.themepunch.revolution.min.js"></script>
	<!-- SLIDER REVOLUTION 5.0 EXTENSIONS -->
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.actions.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.migration.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url(); ?>web/external/revolution/js/extensions/revolution.extension.video.min.js"></script>
