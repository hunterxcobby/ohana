								...
								<div class="tab-content">
									...
									<div class="">
										...
										<div class="form-group ">
											<label class="col-sm-2 control-label no-padding-right" for="brand_id"> Store ID : </label>

											<div class="col-sm-4">
												<input type="text" id="store_id" class="form-control" required readonly value="<?php echo $last_id+1; ?>" />
											</div>
											
											<label class="col-sm-2 control-label no-padding-right" for="join_date"> Create Date : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_name"> Store Name : </label>

											<div class="col-sm-4">
												<input type="text" name="store_name" class="form-control" required  />
											</div>
									
											<label class="col-sm-2 control-label no-padding-right" for="store_short"> Short Name : </label>

											<div class="col-sm-4">
												<input type="text" name="store_short" class="form-control" required maxlength="10" placeholder="maximum 10 characters" />
											</div>
										</div>
										
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_add1"> Address 1 : </label>

											<div class="col-sm-4">
												<input type="text" name="store_add1" class="form-control" required  />
											</div>
									
											<label class="col-sm-2 control-label no-padding-right" for="store_add2"> Address 2 : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_city"> Store City : </label>

											<div class="col-sm-4">
												<input type="text" name="store_city" class="form-control" required  />
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="store_state"> Store State : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_zip"> Zip Code : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_phone"> Store Phone : </label>

											<div class="col-sm-4">
												<input type="text" name="store_phone" class="form-control" required  />
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="store_email"> Store Email : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_tax_no"> Store Tax No : </label>

											<div class="col-sm-4">
												<input type="text" name="store_tax_no" class="form-control" required  />
											</div>
										
											<label class="col-sm-2 control-label no-padding-right" for="show_hide">  Show / Hide : </label>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label no-padding-right" for="store_password"> Store Password : </label>

											<div class="col-sm-4">
												<input type="text" name="store_password" class="form-control" required  />
											</div>
											
											<label class="col-sm-2 control-label no-padding-right" for="remarks"> Description : </label>
