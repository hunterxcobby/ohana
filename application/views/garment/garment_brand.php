							...
							<div class="tabbable">
								...
								<div class="tab-content">
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																...
																<td class=""><?php echo $row->brand_remark; ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/garment/brand_crud/do_update/<?php echo $row->id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/garment/brand_crud/delete/<?php echo $row->id;?>');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/garment/brand_crud/do_update/<?php echo $row->id;?>');" class="tooltip-success" data-rel="tooltip" title="<?php echo lang('Edit'); ?> ">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/garment/brand_crud/delete/<?php echo $row->id;?>');" class="tooltip-error" data-rel="tooltip" title="<?php echo lang('Delete'); ?> ">
																						<span class="red">
									...
									<div class="">
										...
										echo form_open('garment/brand_crud/create',$attributes); ?>
