	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active"><?php echo lang('Garment Defects'); ?> </li>
			</ul><!-- /.breadcrumb -->
							...
							<div class="tabbable">
								...
								<div class="tab-content">
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														...
														<tbody>
															...
															<tr>
																...
																<td class=""><?php echo $row->defect_remark; ?> </td>
																...
																<td>
																	<div class="hidden-sm hidden-xs action-buttons">
																		...
																		<a class="green" href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/garment/defect_crud/do_update/<?php echo $row->id;?>');">
																			<i class="ace-icon fa fa-pencil bigger-130"></i>
																		</a>

																		<a class="red" href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/garment/defect_crud/delete/<?php echo $row->id;?>');">
																	...
																	<div class="hidden-md hidden-lg">
																		<div class="inline pos-rel">
																			...
																			<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																				...
																				<li>
																					<a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php/garment/defect_crud/do_update/<?php echo $row->id;?>');" class="tooltip-success" data-rel="tooltip" title="Edit">
																						<span class="green">
																				...
																				<li>
																					<a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php/garment/defect_crud/delete/<?php echo $row->id;?>');" class="tooltip-error" data-rel="tooltip" title="Delete">
																						<span class="red">
									...
									<div class="">
										...
										echo form_open('garment/defect_crud/create',$attributes); ?>
										<div class="table-header" style="background:#69AA46!important;">
													<?php echo lang('New Record'); ?>  
												</div> <br/>
										<div class="form-group ">
											<label class="col-sm-3 control-label no-padding-right" for="defect_id"> <?php echo lang('Defect ID'); ?>  : </label>

											<div class="col-sm-9">
												<input type="text" id="defect_id" class="form-control" required readonly value="<?php echo $last_id+1; ?>" />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text" name="defect_name" class="form-control" placeholder="<?php echo lang('defect_placehold'); ?>"  required  autofocus/>
											</div>
										</div>
