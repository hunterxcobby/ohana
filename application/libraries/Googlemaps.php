...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyBEFYIO_1AEeQUVrSktxbMWSh4VCwBBhdw'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			if ($this->apiKey!="") 
			{
				...
				$apiLocation .= '://maps.googleapis.com/maps/api/js?key='.$this->apiKey.'&v=3&';
			}
			else
			{
